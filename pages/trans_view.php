            ...
            <div class="card-body">
              <div class="form-group row text-left mb-0">
                <div class="col-sm-5 py-1">
                  <a href="transaction.php" type="button" class="btn btn-primary bg-gradient-primary"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back</a>
                </div>
...
?>
            ...
            <div class="form-group row text-left mb-0 py-3">
                <div class="col-sm-4 py-1"></div>
